...
export const QUEST_DEFS: Record<string, QuestDef> = {
  ...
  quest_wolf_001: {
    ...
    description: 'Охотник в Тёмном лесу просит шкуры — убейте волков.',
    npcId:       'hunter',
  ...
  quest_bandit_001: {
    ...
    description: 'В Тёмном лесу засели бандиты. Староста просит проредить их.',
    npcId:       'elder',
    objective:   { description: 'Убить бандитов', required: 3 },
    killTargets: ['Бандит'],
    reward:      { gold: 90, xp: 130, items: ['upgrade_protect'] },
    requiresQuest: 'quest_goblin_001',
  },
  quest_cave_001: {
    id:          'quest_cave_001',
    title:       'Зачистка норы',
    description: 'Волчья пещера кишит мышами и волками. Зачисти вход.',
    npcId:       'elder',
    objective:   { description: 'Убить врагов в пещере', required: 6 },
    killTargets: ['Летучая мышь', 'Волк', 'Альфа-волк'],
    reward:      { gold: 120, xp: 160, items: ['greater_healing_potion'] },
    requiresQuest: 'quest_bandit_001',
  },
  quest_chief_001: {
    id:          'quest_chief_001',
  ...
  quest_report_001: {
    id:          'quest_report_001',
    title:       'Доклад старосте',
    description: 'Главарь пал. Вернись к старосте с докладом о пещере.',
    npcId:       'elder',
  ...
  quest_shards_001: {
    ...
    requiresQuest: 'quest_report_001',
