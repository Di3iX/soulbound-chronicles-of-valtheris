...
export const makeLocationEnemies = (loc: LocationId): Enemy[] => {
  ...
  const spawns: Record<LocationId, Spawn[]> = {
    ...
    wolfcave: [
      // entrance
      { name: 'Летучая мышь', x: 4, y: 14 }, { name: 'Волк', x: 5, y: 16 },
      { name: 'Летучая мышь', x: 6, y: 13 },
      // north
      { name: 'Волк', x: 12, y: 4 }, { name: 'Летучая мышь', x: 15, y: 5 },
      { name: 'Волк', x: 17, y: 6 },
      // center
      { name: 'Волк', x: 12, y: 14 }, { name: 'Альфа-волк', x: 15, y: 15 },
      { name: 'Летучая мышь', x: 17, y: 16 },
      // east
      { name: 'Летучая мышь', x: 22, y: 12 }, { name: 'Волк', x: 24, y: 14 },
      { name: 'Волк', x: 23, y: 16 },
      // south
      { name: 'Альфа-волк', x: 14, y: 22 }, { name: 'Волк', x: 16, y: 24 },
      { name: 'Летучая мышь', x: 18, y: 23 }, { name: 'Волк', x: 12, y: 25 },
    ],
    mountains: [
    ...
    icefort: [
      { name: 'Рыцарь льда', x: 8, y: 24 }, { name: 'Маг льда', x: 12, y: 22 },
      { name: 'Рыцарь льда', x: 18, y: 23 }, { name: 'Маг льда', x: 22, y: 24 },
      { name: 'Рыцарь льда', x: 6, y: 15 }, { name: 'Маг льда', x: 10, y: 14 },
      { name: 'Рыцарь льда', x: 20, y: 14 }, { name: 'Маг льда', x: 24, y: 16 },
      { name: 'Рыцарь льда', x: 14, y: 12 }, { name: 'Маг льда', x: 16, y: 16 },
      { name: 'Рыцарь льда', x: 12, y: 7 }, { name: 'Маг льда', x: 18, y: 7 },
      { name: 'Рыцарь льда', x: 15, y: 9 }, { name: 'Маг льда', x: 10, y: 18 },
      { name: 'Рыцарь льда', x: 20, y: 18 }, { name: 'Маг льда', x: 15, y: 20 },
    ],
  };
