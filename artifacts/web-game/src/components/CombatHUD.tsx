  ...
  return (
    <div className="shrink-0 border-b border-tile-border bg-[#111116]">
      ...
      <div className="flex items-center px-4 pb-2 gap-2">
        <span className="text-[10px] text-[#a78bfa] font-bold uppercase tracking-wide shrink-0">Опыт</span>
        <div className="flex-1 h-[7px] bg-[#1a1a1f] rounded-full overflow-hidden border border-tile-border">
          <div className="h-full rounded-full transition-all duration-500 bg-[#a78bfa]" style={{ width: `${xpPct}%` }} />
        </div>
        <span className="text-[10px] font-mono text-[#a78bfa] shrink-0">{playerXp}/{xpToNext}</span>
